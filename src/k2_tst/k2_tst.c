...
char test_K2[40][15]={{0x55, 0x04, 0x01, 0x0B, 0x65},		// ->+ 0
					...
					//{0x55, 0x05, 0x01, 0x09, 0x01, 0x65}, //Дк.P 16
					...
					{0x55, 0x05, 0x01, 0x2A, 0x03, 0x88}, //32 ОБР-ТЕСТ
...
/**/			case 9: if (comOK[5]>0) {comOK[5]=Ncount=0;N_COM+=4;break;}
			   ...
			   case 14: read_kvit();break;
 			   case 15: write_com(16);printf(")  Команда ДК-Р отправлена\n");break;
			   case 16: read_kvit();break;
 			   case 17: //write_com(34);read_kvit();
						write_com(13);printf(")  Команда Реж-А1 отправлена\n");break;
			   ...
			   case 35: read_kvit();break;
 			   case 36: write_com24(24);printf("  Начата посылка команды ДанИ.V.dV\n");
						...
						Tstart=p->from41.T_SS-12; //время старта за 10 сек до сеанса
